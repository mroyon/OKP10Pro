...
namespace KAF.DataAccessObjects
{
    ...
    internal sealed partial class hr_passportinfoDataAccessObjects : BaseDataAccess, Ihr_passportinfoDataAccessObjects
    {
        ...
        public static void FillParameters(hr_passportinfoEntity hr_passportinfo, DbCommand cmd, Database Database, bool forDelete = false)
        {
            ...
            if (!(string.IsNullOrEmpty(hr_passportinfo.passportfiledescription_2)))
                Database.AddInParameter(cmd, "@PassportFileDescription_2", DbType.String, hr_passportinfo.passportfiledescription_2);
            if (!(string.IsNullOrEmpty(hr_passportinfo.passportfilepath_2)))
                Database.AddInParameter(cmd, "@PassportFilePath_2", DbType.String, hr_passportinfo.passportfilepath_2);
            if (!(string.IsNullOrEmpty(hr_passportinfo.passportfilename_2)))
                Database.AddInParameter(cmd, "@PassportFileName_2", DbType.String, hr_passportinfo.passportfilename_2);
            if (!(string.IsNullOrEmpty(hr_passportinfo.passportfiletype_2)))
                Database.AddInParameter(cmd, "@PassportFileType_2", DbType.String, hr_passportinfo.passportfiletype_2);
            if (!(string.IsNullOrEmpty(hr_passportinfo.passportextension_2)))
                Database.AddInParameter(cmd, "@PassportExtension_2", DbType.String, hr_passportinfo.passportextension_2);
            if ((hr_passportinfo.passportfileid_2.HasValue))
                Database.AddInParameter(cmd, "@PassportFileID_2", DbType.Guid, hr_passportinfo.passportfileid_2);
