...
namespace KAF.DataAccessObjects
{
	...
	internal sealed partial class gen_genderDataAccessObjects : BaseDataAccess, Igen_genderDataAccessObjects
	{
        ...
        public static void FillParameters(gen_genderEntity gen_gender, DbCommand cmd,Database Database,bool forDelete=false)
        {
			...
			if ((gen_gender.ex_date1.HasValue))
				Database.AddInParameter(cmd, "@Ex_Date1", DbType.DateTime, gen_gender.ex_date1);
			if ((gen_gender.ex_date2.HasValue))
				Database.AddInParameter(cmd, "@Ex_Date2", DbType.DateTime, gen_gender.ex_date2);
			if (!(string.IsNullOrEmpty(gen_gender.ex_nvarchar1)))
				Database.AddInParameter(cmd, "@Ex_Nvarchar1", DbType.String, gen_gender.ex_nvarchar1);
			if (!(string.IsNullOrEmpty(gen_gender.ex_nvarchar2)))
				Database.AddInParameter(cmd, "@Ex_Nvarchar2", DbType.String, gen_gender.ex_nvarchar2);
			if (gen_gender.ex_bigint1.HasValue)
				Database.AddInParameter(cmd, "@Ex_Bigint1", DbType.Int64, gen_gender.ex_bigint1);
			if (gen_gender.ex_bigint2.HasValue)
				Database.AddInParameter(cmd, "@Ex_Bigint2", DbType.Int64, gen_gender.ex_bigint2);
			if (gen_gender.ex_decimal1.HasValue)
				Database.AddInParameter(cmd, "@Ex_Decimal1", DbType.Decimal, gen_gender.ex_decimal1);
			if (gen_gender.ex_decimal2.HasValue)
				Database.AddInParameter(cmd, "@Ex_Decimal2", DbType.Decimal, gen_gender.ex_decimal2);
        ...
        long Igen_genderDataAccessObjects.Add(gen_genderEntity gen_gender  )
        {
            long returnCode = -99;
        ...
        long Igen_genderDataAccessObjects.Update(gen_genderEntity gen_gender )
        {
           long returnCode = -99;
        ...
        long Igen_genderDataAccessObjects.Delete(gen_genderEntity gen_gender)
        {
            long returnCode = -99;
		...
		long Igen_genderDataAccessObjects.SaveList(IList<gen_genderEntity> listAdded, IList<gen_genderEntity> listUpdated, IList<gen_genderEntity> listDeleted)
        {
            long returnCode = -99;
       ...
       public long SaveList(Database db , DbTransaction transaction,IList<gen_genderEntity> listAdded, IList<gen_genderEntity> listUpdated, IList<gen_genderEntity> listDeleted)
        {
            long returnCode = -99;
        ...
        IList<gen_genderEntity> Igen_genderDataAccessObjects.GetAll(gen_genderEntity gen_gender)
        {
           try
            {
		...
		IList<gen_genderEntity> Igen_genderDataAccessObjects.GetAllByPages(gen_genderEntity gen_gender)
        {
        try
            {
        ...
        long Igen_genderDataAccessObjects.SaveMasterDethr_familyinfo(gen_genderEntity masterEntity, 
        ...
        long Igen_genderDataAccessObjects.SaveMasterDethr_personalinfo(gen_genderEntity masterEntity, 
                ...
                using (DbCommand cmd = Database.GetStoredProcCommand(SP))
				{
                    ...
                    if (returnCode>0)
                    {
                        if (masterEntity.CurrentState != BaseEntity.EntityState.Deleted)
                        {
                            foreach (var item in listAdded)
                            {
                                item.genderid=PrimaryKeyMaster;
                            }
                        }
        ...
        gen_genderEntity Igen_genderDataAccessObjects.GetSingle(gen_genderEntity gen_gender)
        {
           try
            {
        ...
        IList<gen_genderEntity> Igen_genderDataAccessObjects.GAPgListView(gen_genderEntity gen_gender)
        {
        try
            {
