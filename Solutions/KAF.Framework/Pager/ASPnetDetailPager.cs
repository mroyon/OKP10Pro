...
{
    [ToolboxData("<{0}:ASPnetDetailPager runat=\"server\"></{0}:ASPnetDetailPager>")]
    public class ASPnetDetailPager : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        public event CommandEventHandler Command    ///< Event queue for all listeners interested in Command events.
        {
        ...
        private string RenderFirst()
        {
            ...
            return String.Format(templateCell, "javascript:gotoPageNumberDet('1-" + this.PageSize.ToString() + "')");
        ...
        private string RenderLast()
        {
            ...
            return String.Format(templateCell, "javascript:gotoPageNumberDet('" + this.PageCount.ToString() + "-" + this.PageSize.ToString() + "')");
        ...
        private string RenderBack()
        {
            ...
            return String.Format(templateCell, "javascript:gotoPageNumberDet('" + (this.CurrentIndex - 1).ToString() + "-" + this.PageSize.ToString() + "')");
        ...
        private string RenderOther(int pageNumber)
        {
            ...
            return String.Format(templateCell, "javascript:gotoPageNumberDet('" + pageNumber.ToString() + "-" + this.PageSize.ToString() + "')");
        ...
        private string RenderSSC(int pageNumber)
        {
            ...
            return String.Format(templateCell, "javascript:gotoPageNumberDet('" + pageNumber.ToString() + "')");
        ...
        {
            string templateCell = "<td class=\"PagerOtherPageCells\"><div class=\"pager-goto\"><div onclick=\"handleGotoDetVisibility()\" class=\"GoToLabel\">&nbsp;Go To&nbsp;</div>&nbsp;<div id=\"div_goto\" ><select class=\"GoToSelect\" name=\"ddlTesDet\" id=\"ddlTesDet\" onchange=\"javascript:handleGotoDet(this);\">{0}</select></div></div></td>";
        ...
        private string RenderGoToScript()
        {
            ...
            sb.Append(@"
                                function handleGotoDet(selectObj) {
                                    var ddlTesDet = $(document.getElementById('ddlTesDet')).find('option:selected').text();
                                    var ddlPgSzsDet = $(document.getElementById('ddlPgSzsDet')).find('option:selected').text();
                                    var param =  ddlTesDet + '-' + ddlPgSzsDet;
                                ...
                                function handleGotoDetVisibility() {
            ...
            //sb.AppendFormat("gotoImg.src = gotoElem.style.display == 'none' ? '{0}' : '{1}';", Page.ClientScript.GetWebResourceUrl(this.GetType(), "ASPnetDetailPagerV2_8.Images.arr_right.gif"), Page.ClientScript.GetWebResourceUrl(this.GetType(), "ASPnetDetailPagerV2_8.Images.arr_left.gif") );
            sb.Append("}");
        ...
        {
            string templateCell = "<td><div class=\"row-per-page\"><div class=\"PaseSizeLabel\">Row Per Page</div>&nbsp;<div id=\"div_pagesize\" ><select class=\"PageSizeSelect\" name=\"ddlPgSzsDet\" id=\"ddlPgSzsDet\" onchange=\"javascript:handleGotoDet(this);\">{0}</select></div></div></td>";
        ...
        #region // Override Control's Render operatio
