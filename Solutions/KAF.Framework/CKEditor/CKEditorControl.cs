...
even if the aligment style is not explicitly applied to the current paragraph in the editor.")]
        ...
        /// <summary>   Registers the client script include. </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="RegisterClientScriptInclude" type="void"> RegisterClientScriptInclude. </method>
        /// <param name="type" type="Type"> The type. </param>
        /// <param name="key" type="string">  The key. </param>
        /// <param name="url" type="string">  URL of the document. </param>
        ...
        /// <summary>   Registers the startup script. </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="RegisterStartupScript" type="void">   RegisterStartupScript. </method>
        /// <param name="type" type="Type">             The type. </param>
        /// <param name="key" type="string">              The key. </param>
        /// <param name="script" type="string">           The script. </param>
        /// <param name="addScriptTags" type="bool">    True to add script tags. </param>
        ...
        /// <summary>   Registers the on submit statement. </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="RegisterOnSubmitStatement" type="void">   RegisterOnSubmitStatement. </method>
        /// <param name="type" type="Type">     The type. </param>
        /// <param name="key" type="string">      The key. </param>
        /// <param name="script" type="string">   The script. </param>
...
", this.ClientID, prepareJSON());
        ...
        /// <summary>   Prepare JSON. </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="prepareJSON" type="string"> prepareJSON. </method>
	...
	public class CKEditorControlDesigner : System.Web.UI.Design.ControlDesigner
	{
        ...
        /// </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="GetDesignTimeHtml" type="string">   GetDesignTimeHtml. </method>
