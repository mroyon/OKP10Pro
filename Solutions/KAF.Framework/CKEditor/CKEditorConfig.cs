...
overrides : [ { element : 'font', attributes : { 'size' : null } } ] }";
        ...
        /// <param name="editorPath" type="string">   Full pathname of the editor file. </param>
        ...
        /// <summary>   Resole resolve URL. </summary>
        /// <remarks>   2/6/2017. </remarks>
        /// <method name="ResoleResolveUrl" type="string[]">    ResoleResolveUrl. </method>
        /// <param name="value" type="string[]">        The value. </param>
        /// <param name="resolvedStr" type="string">  The resolved string. </param>
