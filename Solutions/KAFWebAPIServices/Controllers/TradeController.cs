...
namespace KAFWebAPIServices.Controllers
{
    public class TradeController : ApiController
    {
        ...
        [LoggingFilter]
        [ExceptionFilter]
        [Route("api/Trade/getTradeKWData")]
        public async Task<IHttpActionResult> getTradeKWData(string searchTerm, int? pageSize, int? pageNum, string param)
        {
            try
            {
                ...
                gen_tradeEntity input = new gen_tradeEntity();
                ...
                var itemList = new List<gen_tradeEntity>();
                itemList = KAF.FacadeCreatorObjects.FacadeCreatorObjectsPartial.FCCSelectTwo.GetFacadeCreate().GetPaged_Gen_Trade(input).ToList();
        ...
        [LoggingFilter]
        [ExceptionFilter]
        [Route("api/Trade/getTradeBDData")]
        public async Task<IHttpActionResult> getTradeBDData(string searchTerm, int? pageSize, int? pageNum, string param)
        {
            try
            {
                CommonDTO common = new CommonDTO();
