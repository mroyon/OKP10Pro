...
{
    [Serializable]
    [DataContract(Name = "stp_countrycityEntity", Namespace = "http://www.KAF.com/types")]
    public  class stp_countrycityEntity : BaseEntity
    {
        #region Properties
    
        protected long ? _cityid;
        protected long ? _countryid;
        protected long ? _parentcityid;
        protected long ? _levelnumber;
        ...
        {
            get { return _parentcityid; }
            set { _parentcityid = value; this.OnChnaged(); }
        }
        ...
        public long ? levelnumber
        {
            ...
            set { _levelnumber = value; this.OnChnaged(); }
        }
        ...
        public stp_countrycityEntity():base()
        {
        }
        
        public stp_countrycityEntity(IDataReader reader)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("ParentCityID"))) _parentcityid = reader.GetInt64(reader.GetOrdinal("ParentCityID"));
                if (!reader.IsDBNull(reader.GetOrdinal("LevelNumber"))) _levelnumber = reader.GetInt64(reader.GetOrdinal("LevelNumber"));
