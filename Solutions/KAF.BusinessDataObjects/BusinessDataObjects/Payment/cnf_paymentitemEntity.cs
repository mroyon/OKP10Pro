...
{
    [Serializable]
    [DataContract(Name = "cnf_paymentitemEntity", Namespace = "http://www.KAF.com/types")]
    public partial class cnf_paymentitemEntity : BaseEntity
    {
        #region Properties
        ...
        public string itemname
        {
            ...
            set { _itemname = value; this.OnChnaged(); }
        }
        ...
        public cnf_paymentitemEntity():base()
        {
        }
        
        public cnf_paymentitemEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public cnf_paymentitemEntity(IDataReader reader, bool IsListViewShow)
        {
