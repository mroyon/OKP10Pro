...
{
    [Serializable]
    [DataContract(Name = "gen_grouprankEntity", Namespace = "http://www.KAF.com/types")]
    public partial class gen_grouprankEntity : BaseEntity
    {
        #region Properties
    
        protected long ? _grouprankid;
        protected long ? _groupid;
        protected long ? _rankid;
        protected long ? _ranksl;
        ...
        {
            get { return _grouprankid; }
            set { _grouprankid = value; this.OnChnaged(); }
        }
        ...
        {
            get { return _ranksl; }
            set { _ranksl = value; this.OnChnaged(); }
        }
        ...
        public gen_grouprankEntity():base()
        {
        }
        
        public gen_grouprankEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public gen_grouprankEntity(IDataReader reader, bool IsListViewShow)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("GroupRankID"))) _grouprankid = reader.GetInt64(reader.GetOrdinal("GroupRankID"));
