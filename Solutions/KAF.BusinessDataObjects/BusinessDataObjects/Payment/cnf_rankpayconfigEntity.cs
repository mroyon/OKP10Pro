...
{
    [Serializable]
    [DataContract(Name = "cnf_rankpayconfigEntity", Namespace = "http://www.KAF.com/types")]
    public partial class cnf_rankpayconfigEntity : BaseEntity
    {
        #region Properties

        protected long? _payconfigid;
        ...
        {
            get { return _payconfigid; }
            set { _payconfigid = value; this.OnChnaged(); }
        }
        ...
        public cnf_rankpayconfigEntity():base()
        {
        }
        
        public cnf_rankpayconfigEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public cnf_rankpayconfigEntity(IDataReader reader, bool IsListViewShow)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("PayConfigID"))) _payconfigid = reader.GetInt64(reader.GetOrdinal("PayConfigID"));
