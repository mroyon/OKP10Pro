...
{
    [Serializable]
    [DataContract(Name = "tran_manpowerstateEntity", Namespace = "http://www.KAF.com/types")]
    public partial class tran_manpowerstateEntity : BaseEntity
    {
        #region Properties
        ...
        [DataMember]
        [Display(Name = "okpid", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._tran_manpowerstate), ErrorMessageResourceName = "okpidRequired")]
        public long ? okpid
        {
            get { return _okpid; }
        ...
        [DataMember]
        [Display(Name = "manpowerstatedate", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._tran_manpowerstate), ErrorMessageResourceName = "manpowerstatedateRequired")]
        ...
        [DataMember]
        [Display(Name = "isprepared", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "prepareddate", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "preparedby", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "isreviewed", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "reviewdate", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "reviewedby", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "reviewremarks", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "isapproved", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "approvedate", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [Display(Name = "approveby", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "approveremarks", ResourceType = typeof(KAF.MsgContainer._tran_manpowerstate))]
        ...
        public tran_manpowerstateEntity():base()
        {
        }
        
        public tran_manpowerstateEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public tran_manpowerstateEntity(IDataReader reader, bool IsListViewShow)
        {
