...
namespace KAF.BusinessDataObjects
{
    ...
    public partial class owin_lastworkingpageEntity : BaseEntity
    {
        ...
        [DataMember]
        [Display(Name = "appformid", ResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage), ErrorMessageResourceName = "appformidRequired")]
        ...
        [DataMember]
        [Display(Name = "userid", ResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage), ErrorMessageResourceName = "useridRequired")]
        public Guid ? userid
        {
            get { return _userid; }
        ...
        [DataMember]
        [Display(Name = "masteruserid", ResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage), ErrorMessageResourceName = "masteruseridRequired")]
        ...
        [DataMember]
        [Display(Name = "lastentrydate", ResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._owin_lastworkingpage), ErrorMessageResourceName = "lastentrydateRequired")]
