...
namespace KAF.BusinessDataObjects
{
    ...
    public partial class gen_relationshipEntity : BaseEntity
    {
        ...
        [DataMember]
        [MaxLength(50)]
        [Display(Name = "relationshipname", ResourceType = typeof(KAF.MsgContainer._gen_relationship))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._gen_relationship), ErrorMessageResourceName = "relationshipnameRequired")]
        ...
        [DataMember]
        [Display(Name = "priority", ResourceType = typeof(KAF.MsgContainer._gen_relationship))]
        ...
        [DataMember]
        [Display(Name = "forself", ResourceType = typeof(KAF.MsgContainer._gen_relationship))]
        public bool ? forself
        {
            get { return _forself; }
            set { _forself = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(KAF.MsgContainer._gen_relationship))]
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("ForSelf"))) _forself = reader.GetBoolean(reader.GetOrdinal("ForSelf"));
