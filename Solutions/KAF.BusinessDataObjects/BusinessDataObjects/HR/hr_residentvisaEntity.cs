...
{
    [Serializable]
    [DataContract(Name = "hr_residentvisaEntity", Namespace = "http://www.KAF.com/types")]
    public partial class hr_residentvisaEntity : BaseEntity
    {
        #region Properties
        ...
        public long ? residentid
        {
            ...
            set { _residentid = value; this.OnChnaged(); }
        }
        
        [DataMember]
        [Display(Name = "hrbasicid", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._hr_residentvisa), ErrorMessageResourceName = "hrbasicidRequired")]
        ...
        [DataMember]
        [Display(Name = "passportid", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._hr_residentvisa), ErrorMessageResourceName = "passportidRequired")]
        ...
        [DataMember]
        [MaxLength(50)]
        [Display(Name = "residencynumber", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._hr_residentvisa), ErrorMessageResourceName = "residencynumberRequired")]
        ...
        [DataMember]
        [Display(Name = "issuedate", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._hr_residentvisa), ErrorMessageResourceName = "issuedateRequired")]
        ...
        [DataMember]
        [Display(Name = "expirydate", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        [Required(ErrorMessageResourceType = typeof(KAF.MsgContainer._hr_residentvisa), ErrorMessageResourceName = "expirydateRequired")]
        ...
        [DataMember]
        [Display(Name = "isfamilyvisa", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "filedescription", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "filepath", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "filename", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "filetype", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [MaxLength(250)]
        [Display(Name = "extension", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        [DataMember]
        [Display(Name = "fileno", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        public Guid ? fileno
        {
            get { return _fileno; }
        ...
        [DataMember]
        [MaxLength(550)]
        [Display(Name = "remarks", ResourceType = typeof(KAF.MsgContainer._hr_residentvisa))]
        ...
        public hr_residentvisaEntity():base()
        {
        }
        
        public hr_residentvisaEntity(IDataReader reader)
        {
            this.LoadFromReader(reader);
        }
        
         public hr_residentvisaEntity(IDataReader reader, bool IsListViewShow)
        {
        ...
        protected void LoadFromReader(IDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("ResidentID"))) _residentid = reader.GetInt64(reader.GetOrdinal("ResidentID"));
