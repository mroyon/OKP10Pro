...
[Serializable]
	public class KAF_GetVisaSentListByVisaSentIDEntity:  BaseEntity
	{
		...
		public KAF_GetVisaSentListByVisaSentIDEntity():base()
		{

		}

		public KAF_GetVisaSentListByVisaSentIDEntity(IDataReader reader)
		{
		...
		protected void LoadFromReader(IDataReader reader)
		{
			...
			if (!reader.IsDBNull(reader.GetOrdinal("PTIDemandDetlID"))) _PTIDetlID = reader.GetInt64(reader.GetOrdinal("PTIDemandDetlID"));
			if (!reader.IsDBNull(reader.GetOrdinal("PTADemandID"))) _PTIID = reader.GetInt64(reader.GetOrdinal("PTADemandID"));
