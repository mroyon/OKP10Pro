...
[Serializable]
	public class KAF_GetReplacementListByREplacementIDEntity:  BaseEntity
	{
		...
		public KAF_GetReplacementListByREplacementIDEntity():base()
		{

		}

		public KAF_GetReplacementListByREplacementIDEntity(IDataReader reader)
		{
		...
		protected void LoadFromReader(IDataReader reader)
		{
            ...
            if (!reader.IsDBNull(reader.GetOrdinal("LetterNo"))) LetterNo = reader.GetString(reader.GetOrdinal("LetterNo"));
            if (!reader.IsDBNull(reader.GetOrdinal("LetterDate"))) LetterDate = reader.GetDateTime(reader.GetOrdinal("LetterDate"));
