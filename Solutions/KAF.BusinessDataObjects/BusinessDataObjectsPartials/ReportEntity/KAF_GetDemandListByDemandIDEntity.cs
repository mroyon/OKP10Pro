...
[Serializable]
	public class KAF_GetDemandListByDemandIDEntity:  BaseEntity
	{
		...
		public KAF_GetDemandListByDemandIDEntity():base()
		{

		}

		public KAF_GetDemandListByDemandIDEntity(IDataReader reader)
		{
		...
		protected void LoadFromReader(IDataReader reader)
		{
            ...
            if (!reader.IsDBNull(reader.GetOrdinal("FatherName"))) FatherName = reader.GetString(reader.GetOrdinal("FatherName"));
