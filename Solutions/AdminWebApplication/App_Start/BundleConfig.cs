...
namespace AdminWebApp
{
    public class BundleConfig
    {
        ...
        {
            string ltecomponents = "~/DesignsAndScripts/Scripts/AdminWebApp/components/";
            string lteplugins = "~/DesignsAndScripts/Scripts/AdminWebApp/plugins/";
            string lte = "~/DesignsAndScripts/Scripts/AdminWebApp/";
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                .Include(lte + "js/AdminWebApp.min.js")
            ...
            bundles.Add(new StyleBundle("~/Content/css")
                .Include("~/DesignsAndScripts/Content/bootstrap.css")
                ...
                .Include("~/DesignsAndScripts/Content/AdminWebApp/css/AdminWebApp.min.css")
                .Include("~/DesignsAndScripts/Content/AdminWebApp/css/skins/_all-skins.min.css")
