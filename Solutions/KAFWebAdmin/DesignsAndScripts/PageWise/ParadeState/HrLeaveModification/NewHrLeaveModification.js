...
//PN: FILE NAME: "NewHr_LeaveModification.js"
...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnHrLeaveModificationSave', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmHr_LeaveModificationNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "HrLeaveModification/HrLeaveModificationInsert",
                            data: input,
                            type: 'POST',
                                ...
                                if (data.status === "success") {
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                            ...
                                            $('#modal-container-HrLeaveModificationNew').modal('hide');
