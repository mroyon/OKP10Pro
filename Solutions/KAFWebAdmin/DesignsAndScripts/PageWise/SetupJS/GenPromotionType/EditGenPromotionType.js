...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateGenPromotionType', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmGen_PromotionTypeEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "GenPromotionType/GenPromotionTypeUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "GenPromotionType/GenPromotionType";
                                            ...
                                            $('#modal-container-GenPromotionTypeEdit').modal('hide');
