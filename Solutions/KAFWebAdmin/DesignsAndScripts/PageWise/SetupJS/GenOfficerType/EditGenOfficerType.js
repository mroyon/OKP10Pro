...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateGenOfficerType', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmGen_OfficerTypeEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "GenOfficerType/GenOfficerTypeUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "GenOfficerType/GenOfficerType";
                                            $('#mcGenOfficerTypeEdit').html('');
                                            $('#modal-container-GenOfficerTypeEdit').modal('hide');
