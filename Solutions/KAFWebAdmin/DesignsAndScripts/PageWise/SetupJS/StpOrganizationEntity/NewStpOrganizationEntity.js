...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnSaveStpOrganizationEntity', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmStp_OrganizationEntityNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "StpOrganizationEntity/StpOrganizationEntityInsert",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "StpOrganizationEntity/StpOrganizationEntity";
                                            $('#mcStpOrganizationEntityNew').html('');
                                            $('#modal-container-StpOrganizationEntityNew').modal('hide');
