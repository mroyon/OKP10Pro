...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnSaveStpOrganization', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmStp_OrganizationNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "StpOrganization/StpOrganizationInsert",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "StpOrganization/StpOrganization";
                                            ...
                                            $('#modal-container-StpOrganizationNew').modal('hide');
