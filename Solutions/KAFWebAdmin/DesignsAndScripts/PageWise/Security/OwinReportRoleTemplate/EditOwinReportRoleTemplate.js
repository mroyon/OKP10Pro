...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinReportRoleTemplate', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_ReportRoleTemplateEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinReportRoleTemplate/OwinReportRoleTemplateUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinReportRoleTemplate/OwinReportRoleTemplate";
                                            $('#mcOwinReportRoleTemplateEdit').html('');
                                            $('#modal-container-OwinReportRoleTemplateEdit').modal('hide');
