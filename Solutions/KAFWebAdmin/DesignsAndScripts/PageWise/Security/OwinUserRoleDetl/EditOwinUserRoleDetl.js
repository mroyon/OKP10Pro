...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinUserRoleDetl', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_UserRoleDetlEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinUserRoleDetl/OwinUserRoleDetlUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinUserRoleDetl/OwinUserRoleDetl";
                                            ...
                                            $('#modal-container-OwinUserRoleDetlEdit').modal('hide');
