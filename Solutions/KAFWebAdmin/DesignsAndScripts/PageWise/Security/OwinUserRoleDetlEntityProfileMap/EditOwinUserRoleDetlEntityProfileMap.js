...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinUserRoleDetlEntityProfileMap', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_UserRoleDetlEntityProfileMapEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinUserRoleDetlEntityProfileMap/OwinUserRoleDetlEntityProfileMapUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinUserRoleDetlEntityProfileMap/OwinUserRoleDetlEntityProfileMap";
                                            ...
                                            $('#modal-container-OwinUserRoleDetlEntityProfileMapEdit').modal('hide');
