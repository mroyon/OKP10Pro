...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinReportPermission', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_ReportPermissionEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinReportPermission/OwinReportPermissionUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinReportPermission/OwinReportPermission";
                                            ...
                                            $('#modal-container-OwinReportPermissionEdit').modal('hide');
