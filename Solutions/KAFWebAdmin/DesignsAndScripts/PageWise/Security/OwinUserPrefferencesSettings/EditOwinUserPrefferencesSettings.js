...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinUserPrefferencesSettings', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_UserPrefferencesSettingsEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinUserPrefferencesSettings/OwinUserPrefferencesSettingsUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinUserPrefferencesSettings/OwinUserPrefferencesSettings";
                                            ...
                                            $('#modal-container-OwinUserPrefferencesSettingsEdit').modal('hide');
