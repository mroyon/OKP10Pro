...
//PN: FILE NAME: "Newowin_userrole.js"
...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateOwinUserRole', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmOwin_UserRoleEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinUserRole/OwinUserRoleUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinUserRole/OwinUserRole";
                                            ...
                                            $('#modal-container-OwinUserRoleEdit').modal('hide');
