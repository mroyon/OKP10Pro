...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnSaveOwinFormInfo', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmOwin_FormInfoNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "OwinFormInfo/OwinFormInfoInsert",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "OwinFormInfo/OwinFormInfo";
                                            $('#mcOwinFormInfoNew').html('');
                                            $('#modal-container-OwinFormInfoNew').modal('hide');
