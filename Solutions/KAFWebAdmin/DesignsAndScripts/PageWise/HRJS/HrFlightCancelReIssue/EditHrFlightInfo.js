...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateHrFlightCancelReissue', function (event) {
        try {
            ...
            $("#GenflightDt .txtdetailinfo").each(function (index) {
                ...
                if (
                    ...
                    var inputdetl = AddAntiForgeryToken({
                        ...
                        CurrentState: $(this).parent().parent().find(".chkSelect").prop("checked") == true ? 2 : 3
                ...
                if ($("#GenflightDt .chkSelect:checked").length == 0) {
                    ...
                    confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                        if (answer == "true") {
                            ...
                            $.ajax({
                                url: baseurl + "HrFlightCancelReIssue/HrFlightCancelReIssueUpdate",
                                data: input,
                                type: 'POST',
    ...
    $('body').on('click', '#btnDeleteHrFlightCancelReissue', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmHr_FlightInfoEdit');
            jQuery.validator.unobtrusive.parse();
            ...
            if (form.valid()) {
                ...
                var input = AddAntiForgeryToken({
                    ...
                    CurrentState: 3 //$("#existingreppassportid").val() == null ? 1 : 2,
