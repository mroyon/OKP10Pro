...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnSaveHRBasicProfile', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmHR_BasicProfileNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "HRBasicProfile/HRBasicProfileInsert",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "HRBasicProfile/HRBasicProfile";
                                            $('#mcHRBasicProfileNew').html('');
                                            $('#modal-container-HRBasicProfileNew').modal('hide');
