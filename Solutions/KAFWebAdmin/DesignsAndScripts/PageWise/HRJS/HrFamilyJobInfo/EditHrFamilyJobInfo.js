...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateHrFamilyJobInfo', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmHr_FamilyJobInfoEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "HrFamilyJobInfo/HrFamilyJobInfoUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "HrFamilyJobInfo/HrFamilyJobInfo";
                                            $('#mcHrFamilyJobInfoEdit').html('');
                                            $('#modal-container-HrFamilyJobInfoEdit').modal('hide');
