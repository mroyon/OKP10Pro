...
function GetAllDataHrFlightInfo() {
    try {
        ...
        $('#HrFlightInfoDt').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": baseurl + "HrFlightInfo/HrFlightInfoTableData",
                "type": "POST",
                "data": input
            },
...
$('body').on('click', '#btnNewHrFlightInfo', function (event) {
    try {
        ...
        $.ajax({
            url: baseurl + "HrFlightInfo/HrFlightInfoNew",
            type: 'POST',
            data: input,
    ...
    try {
        confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_deleteConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
            if (answer == "true") {
                ...
                $.ajax({
                    url: baseurl + "HrFlightInfo/HrFlightInfoDelete",
                    data: input,
                    type: 'POST',
                    success: function (response) {
...
function HrFlightInfoEdit(val) {
    try {
        ...
        $.ajax({
            url: baseurl + "HrFlightInfo/HrFlightInfoEdit",
            type: 'POST',
            data: input,
            success: function (response) {
...
function HrFlightInfoDetail(val) {
    try {
        ...
        $.ajax({
            url: baseurl +  "HrFlightInfo/HrFlightInfoDetail",
            type: 'POST',
            data: input,
            success: function (response) {
                $('#mcHrFlightInfoDetail').html('');
