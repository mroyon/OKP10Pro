...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnSaveHrPersonalInfo', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmHr_PersonalInfoNew');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "HrPersonalInfo/HrPersonalInfoInsert",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           window.location.href =  baseurl + "HrPersonalInfo/HrPersonalInfo";
                                            ...
                                            $('#modal-container-HrPersonalInfoNew').modal('hide');
