...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateHrReplacementInfoDetl', function (event) {
        try {
            event.preventDefault();

            var form = $('#frmHr_ReplacementInfoDetlEdit');
            ...
            if (form.valid()) {
                ...
                confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                    if (answer == "true") {
                        ...
                        $.ajax({
                            url: baseurl + "HrReplacementInfoDetl/HrReplacementInfoDetlUpdate",
                            data: input,
                            type: 'POST',
                                    ...
                                    inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                        if (answer == "true") {
                                           //window.location.href =  baseurl + "HrReplacementInfoDetl/HrReplacementInfoDetl";
                                            ...
                                            $('#modal-container-HrReplacementInfoDetlEdit').modal('hide');
