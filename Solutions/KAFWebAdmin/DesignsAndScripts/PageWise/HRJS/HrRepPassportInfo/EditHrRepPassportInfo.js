...
$(document).ready(function () {
    ...
    $('body').on('click', '#btnUpdateHrRepPassportInfo', function (event) {
        try {
            event.preventDefault();
            var form = $('#frmHr_RepPassportInfoEdit');
            ...
            if (form.valid()) {
                ...
                if ($("#GenRepPassportDt tr").length == 1) {
                    ...
                    confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_saveConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
                        if (answer == "true") {
                            ...
                            $.ajax({
                                url: baseurl + "HrRepPassportInfo/HrRepPassportInfoUpdate",
                                data: input,
                                type: 'POST',
                                    ...
                                    if (data.status === "success") {
                                        inforamtionDialog(data.title, data.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                            if (answer == "true") {
                                                ...
                                                $('#modal-container-HrRepPassportInfoEdit').modal('hide');
