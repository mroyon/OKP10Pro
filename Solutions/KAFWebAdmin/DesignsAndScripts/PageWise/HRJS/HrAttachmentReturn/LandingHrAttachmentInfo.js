...
function GetDataHrBasicProfile() {
    try {
        ...
        $.ajax({
            url: baseurl + "HrAttachmentReturn/GetAllHrBasicProfileData?militaryno=" + $('#militarynokw').val(),
            type: 'POST',
            data: null,
...
function GetAllDataHrAttachmentInfo() {
    try {
        ...
        $('#HrAttachmentInfoDt').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": baseurl + "HrAttachmentReturn/HrAttachmentInfoTableData",
                "type": "POST",
                "data": input
            },
...
$('body').on('click', '#btnNewHrAttachmentInfo', function (event) {
    try {
        ...
        $.ajax({
            url: baseurl + "HrAttachmentReturn/HrAttachmentInfoNew",
            type: 'POST',
            data: input,
            success: function (response) {
    ...
    try {
        confirmationDialog(_getCookieForLanguage("_confirmationTitle"), _getCookieForLanguage("_deleteConfirmation"), _getCookieForLanguage("_btnYes"), _getCookieForLanguage("_btnNo")).then(function (answer) {
            if (answer == "true") {
                ...
                $.ajax({
                    url: baseurl + "HrAttachmentReturn/HrAttachmentInfoDelete",
                    data: input,
                    type: 'POST',
                    success: function (response) {
                        if (response.status == "success") {
                            inforamtionDialog(response.title, response.responsetext, _getCookieForLanguage("_btnOK")).then(function (answer) {
                                //window.location.href = baseurl + "HrAttachmentReturn/HrAttachmentReturn";
                                GetAllDataHrAttachmentInfo();
                            });
                        }
                        else {
...
function HrAttachmentInfoEdit(val) {
    try {
        ...
        $.ajax({
            url: baseurl + "HrAttachmentReturn/HrAttachmentInfoEdit",
            type: 'POST',
            data: input,
            success: function (response) {
...
function HrAttachmentInfoDetail(val) {
    try {
        ...
        $.ajax({
            url: baseurl + "HrAttachmentReturn/HrAttachmentInfoDetail",
            type: 'POST',
            data: input,
            success: function (response) {
