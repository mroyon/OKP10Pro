...
{
    public class UserStatusLockController : BaseController
    {
        ...
        public async Task<ActionResult> UserStatusLockView()
        {
            return View();
        }
        ...
        [ExceptionFilterAttribute]
        [RequestValidationAttribute]
        public async Task<ActionResult> UpdateLockStatus(owin_userEntity input)
        {
            string str = string.Empty;
            try
            {
                ...
                if (this.ModelState.IsValid)
                {
                    ...
                    Int64 ret = KAF.FacadeCreatorObjects.FacadeCreatorObjectsPartial.FCCKAFUserSecurity.GetFacadeCreate().UserStatusLockUpdate(input);
                    if (ret > 0)
