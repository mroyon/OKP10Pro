...
namespace KAFWebAdmin.Controllers.HR
{
    ...
    public class TranManpowerStateReviewController : BaseController
    {
        /// <summary>
        ...
        /// <summary>
        /// Trans the manpower state review.
        /// </summary>
        /// <returns></returns>
        ...
        //Datatable load
        /// <summary>
        /// Trans the manpower state review table data.
        /// </summary>
        ...
        [ValidateAntiForgeryToken]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewTableData([ModelBinder(typeof(DataTablesBinder))] IDataTablesRequest requestModel, tran_manpowerstateEntity input)
        {
            tran_manpowerstateEntity objowin_tran_manpowerstate = new tran_manpowerstateEntity();
            JsonResult result = new JsonResult();
            try
            {
                ...
                List<tran_manpowerstateEntity> data = this.GetAllTranManpowerStateReviewData(input);
                ...
                if (data != null && data.Count > 0)
                {
                    ...
                    var tut = (from t in data
                               select new
                               {
                                  ...
                                  t.isreviewed == null ? "TranManpowerStateReview/TranManpowerStateReviewEdit" : "", "TranManpowerStateReviewEdit",
                                   "", "TranManpowerStateReviewDelete",
                                   "TranManpowerStateReview/TranManpowerStateReviewDetail", "TranManpowerStateReviewDetail")
                               }).ToList();
                    ...
                    if (itemList != null && itemList.Count > 0)
                    {
                        ...
                        if (!String.IsNullOrEmpty(actionNameEdit))
                        {
                            if (itemList.Exists(p => p.ActionName.Contains(actionNameEdit)))
                            {
                                ...
                                strValue += "<button class='btn btn-primary btn-md' onclick ='" + editMethodName + "(&quot;" + objClsPrivate.BuildUrlMVCOnlyParams(menuName, menuId.ToString()) + "&quot;)'> <i class='fa fa-edit'> </i> Review</button> ";
        ...
        /// <summary>
        /// Gets all tran manpower state review data.
        /// </summary>
        /// <param name="objtran_manpowerstateEntity">The objtran manpowerstate entity.</param>
        /// <returns></returns>
        List<tran_manpowerstateEntity> GetAllTranManpowerStateReviewData(tran_manpowerstateEntity objtran_manpowerstateEntity)
        {
        ...
        #region Create TranManpowerStateReview

        //Create Page Load
        /// <summary>
        /// Trans the manpower state review new.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewNew(KAFProcess_ManpoewrStateEntity input)
        {
            try
            {
                ModelState.Clear();
                return PartialView("_TranManpowerStateReviewNew", input);
            }
            catch (Exception ex)
            {
                return Json(new { status = KAF.MsgContainer._Status._statusFailed, title = KAF.MsgContainer._Status._titleGenericError, redirectUrl = "", responsetext = ex.Message });
        ...
        /// <summary>
        /// Trans the manpower state review insert.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewInsert(KAFProcess_ManpoewrStateEntity input)
        {
            try
            {
                JsonResult result = new JsonResult();
        ...
        //Create Page Create Action
        /// <summary>
        /// Trans the manpower state review view processed detail.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewViewProcessedDetail(KAFProcess_ManpoewrStateEntity input)
        {
            try
            {
                JsonResult result = new JsonResult();
        ...
        #region update TranManpowerStateReview

        //Update Page Load
        /// <summary>
        /// Trans the manpower state review edit.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewEdit(tran_manpowerstateEntity input)
        {
            SecurityCapsule sec = new SecurityCapsule();
            try
            {
                ...
                return PartialView("_TranManpowerStateReviewEdit", model);
            }
            catch (Exception ex)
            {
                return Json(new { status = KAF.MsgContainer._Status._statusFailed, title = KAF.MsgContainer._Status._titleGenericError, redirectUrl = "", responsetext = ex.Message });
        ...
        /// <summary>
        /// Trans the manpower state review update.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewUpdate(tran_manpowerstateEntity input)
        {
            try
            {
                string redirectURL = "";
        ...
        #region delete TranManpowerStateReview

        //Delete Page Delete Action
        /// <summary>
        /// Trans the manpower state review delete.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [SecurityFillerAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewDelete(tran_manpowerstateEntity input)
        {
            string str = string.Empty;
            string redirectURL = "";
            Int64 ret = 0;
        ...
        #region detail TranManpowerStateReview

        //Detail Page Load
        /// <summary>
        /// Trans the manpower state review detail.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns></returns>
        [HttpPost]
        ...
        [RequestValidationAttribute]
        [ExceptionFilterAttribute]
        public async Task<ActionResult> TranManpowerStateReviewDetail(tran_manpowerstateEntity input)
        {
            SecurityCapsule sec = new SecurityCapsule();
            try
            {
                ...
                ModelState.Clear();
                return PartialView("_TranManpowerStateReviewDetail", model);
            }
            catch (Exception ex)
            {
                return Json(new { status = KAF.MsgContainer._Status._statusFailed, title = KAF.MsgContainer._Status._titleGenericError, redirectUrl = "", responsetext = ex.Message });
