...
public partial class DownloadReportPhaseWise : Page
{
    ...
    private void LoadReport(string letterstatus, string masterid)
    {
        if (letterstatus == "1") //replacement
        {
            ...
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_ReplacementReport.rdlc");
        ...
        else if (letterstatus == "2") //replacement passport
        {
            ...
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_ReplPassportReport.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
        ...
        else if (letterstatus == "3" && Request.QueryString["demandtype"] !=null) //visa demand
        {
            ...
            var list = KAF.FacadeCreatorObjects.FacadeCreatorObjectsPartial.FCCReportExtension.GetFacadeCreate().GET_KAF_GetDemandListByDemandID(new KAF_GetDemandListByDemandIDEntity { DemandID = Convert.ToInt64(masterid), IsAll = 5 }).ToList();

            if (list.Count > 0)
            {
                if(Request.QueryString["demandtype"]=="2")
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_visademand_newdemand.rdlc");
                else
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_visademand_replacement.rdlc");
        ...
        else if (letterstatus == "4") //visa issue
        {
            ...
            if (list.Count > 0)
            {
                if(list[0].DemandType==1)
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_issueofvisaandpta_replacement.rdlc");
                else
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_issueofvisaandpta_newdemand.rdlc");
        ...
        else if (letterstatus == "5") //visa sent
        {
            ...
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_visasent.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
        ...
        else if (letterstatus == "6") //pta demand
        {
            ...
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_pta_demand.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
        ...
        else if (letterstatus == "7") //pta received
        {
            ...
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_pta_received.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
        ...
        {
            var list = KAF.FacadeCreatorObjects.FacadeCreatorObjectsPartial.FCCReportExtension.GetFacadeCreate().GET_KAF_GetFlightListByFlightID(new KAF_GetFlightListByFlightIDEntity{ FlightID = Convert.ToInt64(masterid), IsAll = 5 }).ToList();

            if (list.Count > 0)
            {

                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_flightinfo.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
        ...
        else if (letterstatus == "9") //arrival
        {
            ...
            {
                if (list[0].DemandType == 1)
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_arrivalreport_replacement.rdlc");
                else
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_arrivalreport_newdemand.rdlc");
        ...
        else if (letterstatus == "13") //new demand
        {
           var list= KAF.FacadeCreatorObjects.FacadeCreatorObjectsPartial.FCCReportExtension.GetFacadeCreate().GET_rpt_newdemanddetails(new rpt_newdemanddetailsEntity { NewDemandID = Convert.ToInt64(masterid) }).ToList();
            if (list.Count > 0)
            {
                ...
                CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/RDLC/PhaseWise/rdlc_newdemanddetails.rdlc");
                CustomerListReportViewer.LocalReport.DataSources.Clear();
                ReportDataSource rdc = new ReportDataSource("DataSet1", list);
