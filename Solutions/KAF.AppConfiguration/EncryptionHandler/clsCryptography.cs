...
namespace KAF.AppConfiguration.EncryptionHandler
{
    ...
    public class SymCryptography
    {
        ...
        /// <summary>   Gets legal key. </summary>
        ///
        /// <remarks>   User, 2/1/2017. </remarks>
        ///
    ...
    public class Hash
    {
        ...
        /// <summary>   Encrypts. </summary>
        /// <remarks>   2/1/2017. </remarks>
        /// <method name="Encrypt"  type="virtual string"> "Encrypt". </method>
        /// <param name="plainText" type="string">    The plain text. </param>
        /// <returns>   A string. </returns>
        ...
        /// <summary>   Decrypts. </summary>
        /// <remarks>   2/1/2017. </remarks>
        /// <method name="Decrypt"> Decrypt. </method>
        /// <param name="plainText">    The plain text. </param>
        /// <returns>   A string. </returns>
